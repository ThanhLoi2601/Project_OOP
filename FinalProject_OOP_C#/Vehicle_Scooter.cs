...
{
    class Vehicle_Scooter : Vehicle
    {
        // Battery là xăng 
        //dịch vụ là đổ xăng 
        public Vehicle_Scooter() : base()
        {
            this.Veh_Money = 50;
        }

        public Vehicle_Scooter(string iD, string type, string locate, DateTime in_time, DateTime out_time, int battery) : base(iD, type, locate, in_time, out_time)
        {
            this.Veh_Battery = battery;
            this.Veh_Money = 50;
        }
        public Vehicle_Scooter(string iD, string type, string locate, DateTime in_time, int battery) : base(iD, type, locate, in_time)
        {
            this.Veh_Battery = battery;
            this.Veh_Money = 50;
        }

        public Vehicle_Scooter(string iD, string locate, DateTime in_time, DateTime out_time, int battery) : base(iD, locate, in_time)
        {
            this.Veh_Battery = battery;
            this.Veh_Money = 50;
        }

        public Vehicle_Scooter(string iD, string locate, DateTime in_time) : base(iD, locate, in_time)
        {
            this.Veh_Money = 50;
        }
        public Vehicle_Scooter(string iD, DateTime in_time, DateTime out_time) : base(iD, in_time, out_time)
        {
            this.Veh_Money = 50;
        }

        public Vehicle_Scooter(string iD, DateTime in_time) : base(iD, in_time)
        {
            this.Veh_Money = 50;
        }
        ~Vehicle_Scooter()
        ...
        {
            base.Veh_Output();
            Console.WriteLine("{0,10}|", " Scooter");
        }
