...
public class Vehicle_Scooter extends Vehicle
{
	public Vehicle_Scooter() {
		super();
		// TODO Auto-generated constructor stub
	}

	public Vehicle_Scooter(String iD, Date in_time, Date out_time) {
		super(iD, in_time, out_time);
		// TODO Auto-generated constructor stub
		this.Veh_iMoney = 50;
	}

	public Vehicle_Scooter(String iD, Date in_time) {
		super(iD, in_time);
		// TODO Auto-generated constructor stub
		this.Veh_iMoney = 50;
	}

	public Vehicle_Scooter(String iD, String locate, Date in_time, Date out_time, int battery) {
	...
	public Vehicle_Scooter(String iD, String locate, Date in_time) {
		super(iD, locate, in_time);
		// TODO Auto-generated constructor stub
		this.Veh_iMoney = 50;
	}

	public Vehicle_Scooter(String iD, String type, String locate, Date in_time, Date out_time, int battery) {
	...
	public Vehicle_Scooter(String iD, String type, String locate, Date in_time, int battery) {
