...
public class Vehicle_Car  extends Vehicle
{
	...
	public Vehicle_Car(String iD, Date in_time, Date out_time) {
		super(iD, in_time, out_time);
		// TODO Auto-generated constructor stub
		this.Veh_iMoney = 90;
	}

	public Vehicle_Car(String iD, Date in_time) {
		super(iD, in_time);
		// TODO Auto-generated constructor stub
		this.Veh_iMoney = 90;
	}

	public Vehicle_Car(String iD, String locate, Date in_time, Date out_time, int battery) {
	...
	public Vehicle_Car(String iD, String locate, Date in_time) {
		super(iD, locate, in_time);
		// TODO Auto-generated constructor stub
		this.Veh_iMoney = 90;
	}

	public Vehicle_Car(String iD, String type, String locate, Date in_time, Date out_time, int battery) {
	...
	public Vehicle_Car(String iD, String type, String locate, Date in_time, int battery) {
     ...
     public double Veh_Calculate_Money_Other_services()
     {
         ...
         if (this.Veh_iOther_services == 1)
             ...
             tong += (100 - this.Veh_iBattery) * 5000 + 300000;
